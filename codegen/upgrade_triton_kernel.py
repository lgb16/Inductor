...
from .triton import (
    ...
    TritonCSE,
    texpr,
    CooperativeReductionWorkspaceCache,
    BlockParameters,
    TritonSymbols,
    BlockPtrOptions,
    IndexingOptions,
...
class Upgrade_TritonKernel(SIMDKernel):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.range_trees_map = Dict[BaseSchedulerNode, List[IterationRangesRoot]]
    ...
    #     if config.generate_all_triton_config:
    #         heuristics_line = f"""
